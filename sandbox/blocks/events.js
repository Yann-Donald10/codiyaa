function registerEventBlocks(Blockly) {
  ...
  Blockly.defineBlocksWithJsonArray([
    {
      type: "event_start",
      message0: "%1",
      args0: [{ type: "field_image", src: ICON_PLAY, width: 44, height: 44, alt: "start" }],
      nextStatement: null,
      colour: "#F2E7D0",
      inputsInline: true,
      extensions: ["codiyaa_pattern_events"]
    },
    {
      type: "event_stop",
      message0: "%1",
      args0: [{ type: "field_image", src: ICON_STOP, width: 44, height: 44, alt: "stop" }],
    ...
    },
    {
      ...
      message0: "%1",
      args0: [{ type: "field_image", src: ICON_SPRITE, width: 88, height: 44, alt: "sprite" }],
      previousStatement: null,
      nextStatement: null,
      colour: "#F2E7D0",
      inputsInline: true,
    ...
    },
    {
      ...
      message0: "%1",
      args0: [{ type: "field_image", src: ICON_BG, width: 70, height: 44, alt: "background" }],
      previousStatement: null,
      nextStatement: null,
      colour: "#F2E7D0",
      inputsInline: true,
